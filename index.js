...
const FORMATS = {
  ...
  career: {
    ...
    guide: [
      ...
      "- 제목: ## AI 활용 역량",
      "- 불릿 4~6개. 공식: **역량명(굵게)** + 행동동사로 시작하는 서술 + 기술/도구 + 측정 결과",
      "  예: '**AI 도구 자산화**: 반복 업무를 Claude Code 커스텀 스킬 10종으로 자동화, 3개월간 1,456회 실전 적용'",
      "- 채용담당자는 평균 31초 스캔 — **가장 강한 신호 2개를 맨 위에** (직접 만든 것 > 운용 규모 > 사용량)",
